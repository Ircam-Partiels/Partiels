...
- [x] Add Rag resources to MCP
- [x] Make instruction and translation consistent 
- [ ] Add MCP server options to Neuralyzer property window
- [ ] Add a main command to initialize Nauralyzer
- [ ] Save right panels state (open/close)
