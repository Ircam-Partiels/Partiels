...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "d7ceb7d1d490674c93d334e5378108c4328e9e05"
  WORKING_DIRECTORY "/home/runner/work/Partiels/Partiels/build_test/_deps/vamp-plugin-sdk-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "d7ceb7d1d490674c93d334e5378108c4328e9e05")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("d7ceb7d1d490674c93d334e5378108c4328e9e05" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: d7ceb7d1d490674c93d334e5378108c4328e9e05")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/d7ceb7d1d490674c93d334e5378108c4328e9e05")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"d7ceb7d1d490674c93d334e5378108c4328e9e05\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/Partiels/Partiels/build_test/_deps/vamp-plugin-sdk-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/Partiels/Partiels/build_test/_deps/vamp-plugin-sdk-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
