...
function(set_target_resources target resource_type source_path)
    ...
    elseif(APPLE)
        ...
        if(resource_type STREQUAL "FILE" OR resource_type STREQUAL "DIRECTORY")
            file(MAKE_DIRECTORY "$${CMAKE_CURRENT_BINARY_DIR}/Package/${dest_dir}")
            file(COPY "${source_path}" DESTINATION "$${CMAKE_CURRENT_BINARY_DIR}/Package/${dest_dir}")
            juce_add_bundle_resources_directory(${target} "$${CMAKE_CURRENT_BINARY_DIR}/Package/${dest_dir}/")
        endif()
    else()
