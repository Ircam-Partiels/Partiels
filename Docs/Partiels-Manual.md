...
>
> The `Force Duration To Full When Editing` setting automatically resets frame durations to their maximum value after editing operations. This is useful for lab format workflows where marker end times should correspond to the start of the next marker or file end. The setting can be toggled via `Partiels → Global Settings → Force Duration To Full When Editing` (Mac) or `Help → Global Settings → Force Duration To Full When Editing` (Linux/Windows).
...
- **Group entries**: Selects or deselects all compatible tracks within the group
...
<p align="center">
<img src="Images/section-export-analyses.2-v2.3.1.png" width="367"/>
</p>
