...
For files in CSV format, you can select the separator character between each column (*Comma*, *Space*, *Tab*, *Pipe*, *Slash*, *Colon*) to ensure compatibility with files generated by other applications that do not use commas. 
