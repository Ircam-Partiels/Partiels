...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 7.0, 477.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-7",
					"maxclass" : "slider",
					"min" : 318.687774658203125,
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 7.0, 306.0, 590.0, 161.0 ],
					"size" : 106.0103759765625
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 511.0, 292.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 203.0, 227.0, 22.0 ],
					"text" : "id /03cb5fd936574caebd686efde3a70f32"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Plots the point data received from the Partiels application"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 7.0, 270.0, 311.0, 22.0 ],
					"text" : "partiels-plot-point /e0996805fc874a6d98e36e7cfa86ac1c"
				}
...
, 			{
		...
		"originid" : "pat-42",
		"dependency_cache" : [ 			{
				"name" : "partiels-plot-point.maxpat",
