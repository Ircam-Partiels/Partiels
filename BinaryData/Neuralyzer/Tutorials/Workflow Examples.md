...
4. Get the summary of results (wait a few seconds if necessary) and adjust the confidence threshold to filter the results accordingly
...
* If you created the pitch track, hide it from the group, get the summary of results (wait a few seconds if necessary) and adjust the confidence threshold to filter the results accordingly
...
5. If no marker track exists, create a Transient Detection - Marker plugin track [identifier="supervp:supervptransientdetection" feature="transientinfo"]
