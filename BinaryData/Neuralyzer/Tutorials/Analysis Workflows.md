...
4. Tips:
  * Reduce the minimum onset time interval to increase the time accuracy of the analysis and increase the energy extra threshold to exclude unwanted results
