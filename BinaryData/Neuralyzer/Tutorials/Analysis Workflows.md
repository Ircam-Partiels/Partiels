...
A series of examples that describes some analysis workflows.
...
4. Export the group as an image and read the content of the image
5. Modify the analysis parameters of the transient tracks or edit directly the results to ensure the transients' markers are consistent with the spectrogram track
6. Go back to the step #4 until the rendering is satisfying
