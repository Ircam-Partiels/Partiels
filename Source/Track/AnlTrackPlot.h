...
namespace Track
{
    ...
    private:
        static void paintMarkers(juce::Graphics& g, juce::Rectangle<float> const& bounds, ColourSet const& colours, std::vector<Plugin::Result> const& results, juce::Range<double> const& timeRange);
        
        static void paintSegments(juce::Graphics& g, juce::Rectangle<float> const& bounds, ColourSet const& colours, std::vector<Plugin::Result> const& results, juce::Range<double> const& timeRange, juce::Range<double> const& valueRange);
