...
namespace Track
{
    namespace Exporter
    {
        ...
        juce::Result toCsv(Accessor const& accessor, Zoom::Range timeRange, std::set<size_t> const& channels, std::ostream& stream, bool includeHeader, char separator, bool useEndTime, bool applyExtraThresholds, bool useSemicolonForLineBreak, bool disableLabelEscaping, bool prependLineIndex, std::atomic<bool> const& shouldAbort);
        ...
        juce::Result toCsv(Accessor const& accessor, Zoom::Range timeRange, std::set<size_t> const& channels, juce::String& string, bool includeHeader, char separator, bool useEndTime, bool applyExtraThresholds, bool useSemicolonForLineBreak, bool disableLabelEscaping, bool prependLineIndex, std::atomic<bool> const& shouldAbort);
