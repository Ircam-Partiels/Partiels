...
namespace Application
{
    namespace Neuralyzer
    {
        namespace Rag
        {
            ...
            void downloadRagModelsIfNecessary();
            ...
            std::vector<Resource> createResources(Ast::Document const& document);
            ...
            public:
                ...
                std::vector<Resource> computeResources(juce::String const& userPrompt, float minScore = 0.5f, float maxDistance = 0.45f);
            ...
            private:
                ...
                llama_token mRerankerYesToken;
                llama_token mRerankerNoToken;
            };
        } // namespace Rag
    } // namespace Neuralyzer
} // namespace Application
