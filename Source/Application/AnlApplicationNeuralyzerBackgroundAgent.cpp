...
Application::Neuralyzer::BackgroundAgent::BackgroundAgent(Mcp::Dispatcher& mcpDispatcher, Guard& guard, Rag::Engine& rag, std::function<juce::Result(void)> setupSystem)
: mMcpDispatcher(mcpDispatcher)
, mAgentLocal(mcpDispatcher, guard, rag)
, mAgentRemote(mcpDispatcher, guard, rag)
{
