...
namespace Application::Neuralyzer::Mcp
{
    ...
    static nlohmann::json listResources()
    {
        ...
        manual["uri"] = partielsManualResourceUri;
        manual["name"] = "Partiels Manual";
        manual["title"] = "Partiels User Manual";
        manual["description"] = "User manual for Partiels";
        manual["mimeType"] = "text/markdown";
        result["resources"].push_back(std::move(manual));
    ...
    static nlohmann::json readResource(nlohmann::json const& request)
    {
        ...
        if(uri == partielsManualResourceUri)
        {
            ...
            content["text"] = juce::String::fromUTF8(AnlNeuralyzerData::PartielsManual_md, AnlNeuralyzerData::PartielsManual_mdSize);
...
bool Application::Neuralyzer::Mcp::Server::setClaudeApplicationEnabled([[maybe_unused]] bool enabled)
{
    ...
    if(enabled)
    {
        json["mcpServers"]["Partiels"] = nlohmann::json{{"command", getPartielsExecutablePath().toStdString()}, {"args", nlohmann::json::array({"--mcp-host"})}, {"timeout", 300000}};
    }
...
bool Application::Neuralyzer::Mcp::Server::setCopilotApplicationEnabled([[maybe_unused]] bool enabled)
{
    ...
    if(enabled)
    {
        json["servers"]["partiels"] = nlohmann::json{{"type", "stdio"}, {"command", getPartielsExecutablePath().toStdString()}, {"args", nlohmann::json::array({"--mcp-host"})}};
    }
