...
namespace Application
{
    namespace Neuralyzer
    {
        namespace Downloader
        {
            ...
            {
            public:
                Process(juce::File outputDirectory, juce::URL sourceUrl, std::function<void(Process const&)> callback);
                ~Process() override;
            ...
            public:
                ...
                bool start(juce::File output, juce::URL url, std::function<void(Process const&)> callback);
