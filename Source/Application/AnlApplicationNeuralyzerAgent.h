...
namespace Application
{
    namespace Neuralyzer
    {
        ...
        public:
            ...
            juce::Result sendQuery(juce::String const& prompt, nlohmann::json const& mcpToolsContext);
        ...
        private:
            ...
            juce::Result performQuery(juce::String const& query, bool allowTools, nlohmann::json const& mcpToolsContext);
