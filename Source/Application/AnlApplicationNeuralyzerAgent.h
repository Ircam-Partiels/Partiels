...
namespace Application
{
    namespace Neuralyzer
    {
        ...
        public:
            ...
            virtual juce::Result sendQuery(juce::String const& prompt, juce::StringArray const& files) = 0;
            ...
            static std::string callTools(Mcp::Dispatcher& mcpDispatcher, Mcp::Dispatcher::DynamicToolMethods const& mcpMethods, std::vector<common_chat_tool_call> const& toolCalls, size_t const maxErrors, size_t& numErrors);

            static auto constexpr kNumInitMessages = 1_z;
        };
