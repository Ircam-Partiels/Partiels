...
namespace Document
{
    ...
    , Model::Attr<AttrType::description, juce::String, Model::Flag::basic>
    >;
    ...
    public:
        ...
        std::unique_ptr<juce::XmlElement> parseXml(juce::XmlElement const& xml, int version) override
        {
            ...
            if(version < 0x20301)
            {
                ...
                XmlParser::migrateContainerFormat(*copy.get(), "reader", "value");
                XmlParser::migrateContainerFormat(*copy.get(), "layout", "value");
            }
            return copy;
        }
    };
