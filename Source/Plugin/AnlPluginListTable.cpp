...
void PluginList::Table::resized()
{
    ...
    mSearchIcon.setBounds(bottomBar.removeFromLeft(20).reduced(2));
    mIrcamIcon.setBounds(bottomBar.removeFromRight(22).reduced(2));
    mSearchField.setBounds(bottomBar);
